import { IonButton, IonContent, IonFab, IonFabButton, IonIcon, IonItem, IonLabel, IonList, IonNote, IonPage, IonRow, IonSpinner, useIonModal } from '@ionic/react';
import "./Page.css"
import "./Hub.css"
...
import { chevronBackOutline, chevronForward, checkmarkCircle } from 'ionicons/icons';
          ...
          <IonList className="change-projects" lines="none">
            ...
            <IonItem color="midblue" button onClick={() => changeProjectSuggestionPresent()}>
              <IonLabel color="navy" className="ion-text-wrap">
                ...
                <p>Want to see it on this list? Let the Refresh Connections team know.</p>
              </IonLabel>
            </IonItem>
