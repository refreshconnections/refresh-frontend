...
const MultipleAccountsDetected: React.FC = () => {
    ...
    return (
        <IonPage>
            ...
            <IonText class="bold" style={{padding: "15pt", textAlign: "center"}}>
          ...
          <IonText class="bold" style={{paddingTop: "15pt", textAlign: "center"}}>
          <p>Please log in with your existing account or use the "Forgot email / password?" button to retrieve your account details.</p>
            ...
            <IonFooter class="ion-text-center" style={{paddingTop: "30pt", paddingBottom: "30pt"}}>
